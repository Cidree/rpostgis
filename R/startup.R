...
.onAttach <- function(libname, pkgname) {
  packageStartupMessage(
    ...
    "------------------ \n",
    "`rpostgis` is under new maintenance, and development will be moving to a new location soon! For more information, see: https://github.com/mablab/rpostgis/issues/28 \n",
    "------------------ \n",
